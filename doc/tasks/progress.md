...
# T76 第三阶段：半透明蒙板与发布页按钮修订（本地完成，待用户验收）

- 基线210bd18；九组无描边24%蒙板、tab去外框，关于两站同样式/12dp间距/无备用；版本1.3.1(3)，仅Android，不发布。
- 完整verify-all：216 suites/2203 tests零失败/错误/跳过，112发布夹具、foundation/boundary各109通过；签名APK/AAB审计通过。最终包44图+关于大字底部补图已验，旧Widget大字label压线及应用大字未穷尽底部限制保留。
- 命令、完整SHA256与失败留痕见[T76](T76-android-transparent-settings-update.md)。下方是旧阶段记录。
...
# T74 Windows UI ������2026-09-15�������У�

�û���Ȩ������������ Windows �� UI�����պ��ٷ��� v1.3.1����������Ծ���� doc/tasks/T74-windows-ui-beautification.md����Χ�� Windows ������������ԣ������ݿ�/WebDAV/AI Э��/Ȩ��/�����仯��Android �������� agent �ֹ���A ���������ȫ�� QSS�����У���B ����������C ������������ݣ�D �Ի�������������B/C/D ���У���Ӳ�Ž���muted �Աȶȡ�rgba/transparent �滻������̬���ֺ�ɨ�衢Canvas ������Լ������ objectName ���İ���

- T74 ��ɣ�Agent A/B/C/D ���߽�ʵʩ������ơ�������������ݡ��Ի����������� agent �����޸� 20px ��ť���С�335/335 unittest��imports��build --check������ PyInstaller��EXE 45,590,808 bytes SHA256 86592e76��aa6dd2����dist/data ǰ�� 5 �ļ�/167951 bytes ժҪ 13bde8e6��a119 һ�¡����� EXE ˫����ð��ȫ���������Light/Dark��8/13/20px �� 38 ͼ��ͼͨ����δ����δ Release�����û����պ� v1.3.1��

# T75 双端 UI 精简与继续美化（2026-09-15，进行中）

用户追加授权：继续美化双端；Windows 删除底栏（功能归设置弹窗）；Android 精简设置说明文字。本轮不推送、不 Release、版本号不动，完成后待用户验收再发 v1.3.1。任务与矩阵见 doc/tasks/T75-dual-platform-ui-refinement.md；Agent W（Windows 底栏删除+顶栏精修）与 Agent A（Android 文字精简+设置 Card 化）并行实施。

- T75 完成（2026-09-15，待用户验收）：Windows 删除底栏（状态消息改日志，主题按钮迁顶栏，同步状态仍到设置弹窗），341/341 unittest、完整 PyInstaller（EXE 45,592,003 bytes SHA256 CD45E36C…AF4B）、dist/data 前后 5 文件/167303 bytes 摘要一致、隔离 EXE 双场景冒烟通过；Android 设置说明文字精简（删 ai_embedded_contract/模型能力提示，12 条 zh/en 短化）+ 三 tab Card 分组与主题分段选择，214 suites/2183 tests（UI 83/915）、112 发布夹具、109+109 策略、verify-all exit 0、四类泄漏 0，签名 APK SHA256 9af70e1e…2ce1f / AAB ff4ec083…9cce，API36 明暗 22 图设备读图通过并清理。版本号未动、未推送、未 Release；用户确认后进入 v1.3.1。详见 doc/tasks/T75-dual-platform-ui-refinement.md。
