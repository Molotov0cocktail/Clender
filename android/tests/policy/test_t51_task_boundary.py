"""T51 adds exactly one task document exception; no real files are inspected."""
...
class T51TaskBoundaryTests(unittest.TestCase):
    ...
    def test_exact_t51_task_document_is_allowed(self):
        self.check_paths("doc/tasks/T51-android-local-time-bugfix.md")

    def test_other_t51_names_and_suffixes_remain_forbidden(self):
        for path in (
            "doc/tasks/T51-other.md",
            "doc/tasks/T51-android-local-time-bugfix.md.bak",
            "doc/tasks/T51-android-local-time-bugfix.md/child.md",
            "doc/tasks/T51-android-local-time-bugfix-extra.md",
